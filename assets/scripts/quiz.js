(function() {
  ...
  var resultData = [
    {
      ...
      cta: { text: 'Запустить бесплатно', href: '#cta', cls: 'btn btn-primary' }
    },
    {
      ...
      cta: { text: 'Подключить команду', href: '#cta', cls: 'btn btn-primary' }
    },
    {
      ...
      cta: { text: 'Запустить пилот', href: '#cta', cls: 'btn btn-primary' }
    }
  ];
  ...
  function finishQuiz() {
    ...
    a.id = 'connectOrgQuiz';
    a.setAttribute('data-connect-cta', '');
